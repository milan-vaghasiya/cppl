		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<div class="float-end">
						<button type="button" class="btn btn-info btn-sm float-right addNew press-add-btn permission-write" data-button="both" data-modal_id="right_modal" data-function="addStatutoryDetail/Taluka" data-form_title="Add Taluka"><i class="fa fa-plus"></i> Add Taluka</button>
					</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id='countryTable' class="table table-bordered ssTable" data-url='/getTalukaDTRows/<?=$type?>'></table>
                        </div>
                    </div>
                </div>
            </div>
