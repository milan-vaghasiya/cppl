                ...
                <ul class="list-unstyled topbar-nav float-end mb-0">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <?php
                                $profileParam = "{'postData':{'id' : ".$this->loginId."},'modal_id' : 'modal-md', 'form_id' : 'empProfile', 'title' : 'Profile','controller':'dashboard','fnedit':'empProfile','button':'close'}";

                            ?>
                            <a class="dropdown-item" href="javascript:void(0)" onclick="edit(<?=$profileParam?>)" ><i class="ti ti-user font-16 me-1 align-text-bottom" ></i> Profile</a>
                            <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#change-psw"><i class="ti ti-key m-r-5 m-l-5"></i> Change Password</a>
                            <div class="dropdown-divider mb-0"></div>
                            <a class="dropdown-item" href="<?=base_url('logout')?>"><i class="ti ti-power font-16 me-1 align-text-bottom"></i> Logout</a>
                        </div>
