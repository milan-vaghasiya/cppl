<head>
	...
	<!-- Sweet Alert -->
	<link href="<?=base_url();?>assets/plugins/sweet-alert2/sweetalert2.min.css?v=<?=time()?>" rel="stylesheet" type="text/css">
	<link href="<?=base_url();?>assets/plugins/animate/animate.min.css" rel="stylesheet" type="text/css">
	<link href="<?=base_url();?>assets/plugins/jqueryui-editable/css/jquery-ui-1.10.1.custom.css" rel="stylesheet">
	<link href="<?=base_url();?>assets/plugins/jqueryui-editable/css/jqueryui-editable.css" rel="stylesheet"/>
