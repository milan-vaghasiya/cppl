		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-title-box">
					<div class="float-end">
						<button type="button" class="btn btn-info btn-sm float-right addNew press-add-btn permission-write" data-button="both" data-modal_id="right_modal_lg" data-function="addEmployee" data-form_title="Add Employee"><i class="fa fa-plus"></i> Add Users</button>
					</div>
					<ul class="nav nav-pills">
						<li class="nav-item"> 
							<button onclick="statusTab('employeeTable',0);" class="nav-tab btn waves-effect waves-light btn-outline-success active" style="outline:0px" data-bs-toggle="tab" aria-expanded="false">Active</button> 
						</li>
						<li class="nav-item"> 
							<button onclick="statusTab('employeeTable',1);" class="nav-tab btn waves-effect waves-light btn-outline-danger" style="outline:0px" data-bs-toggle="tab" aria-expanded="false">Inactive</button> 
						</li>
					</ul>
				</div>
			</div>
