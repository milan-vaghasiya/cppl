    ...
    <div class="page-content">
        ...
        <div class="content-inner pt-0">
			<div class="container bottom-content ">
				...
				<?php
					if(!empty($plumberList)){
						foreach($plumberList as $row){
							$editButton = '<a class="dropdown-item btn btn-success btn-edit permission-modify" href="'.base_url("app/plumber/edit/".$row->id).'" style="justify-content: flex-start;" flow="down"><i class="mdi mdi-square-edit-outline"></i> Edit</a>';
							
							$deleteParam = "{'postData':{'id' : ".$row->id."},'message' : 'Plumber', 'controller' : 'plumber'}";
							$deleteButton = '<a class="dropdown-item btn btn-danger btn-delete permission-remove" href="javascript:void(0)" style="justify-content: flex-start;" onclick="trash('.$deleteParam.');" flow="down"><i class="mdi mdi-trash-can-outline"></i> Delete</a>';
							?>
							<li class="listItem item transition <?=$row->party_name ?>"  data-category="transition">
										...
										<a href="javascript:void(0)">
											<div class="order-content justify-content-between mb-0">
												<div class="right-content">
													...
													<ul>
														<li>
															<p class="order-name"><i class="fas fa-user"></i> <b style="font-weight:bold;">Plumber Name: </b><?= $row->name;?></p>
														</li>
														<li>
															<p class="order-name"><i class="fas fa-phone text-secondary"></i> <b style="font-weight:bold;">Phone No: </b><?= $row->phone_no;?></p>
														</li>
														<?php if(!empty($row->address)):?>
														<li>
															<p class="order-name"><i class="fas fa-location text-secondary"></i> <b style="font-weight:bold;">Address: </b><?= $row->address;?></p>
														</li>
														<?php 
															endif;
															if(!empty($row->adhar_no)):
														?>
														<li>
															<p class="order-name"><i class="fas fa-location text-secondary"></i> <b style="font-weight:bold;">Adhar No: </b><?= $row->adhar_no;?></p>
														</li>
														<?php endif; ?>
													</ul>
												</div>
				...
				<div class="review-box" >
					<a href="<?=base_url("app/plumber/addPlumber/")?>" class="add-btn permission-write" style="margin-bottom:80px">
