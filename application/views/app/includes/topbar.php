		...
		<div class="container">
			<div class="header-content">
				<div class="left-content">
					...
					<h5 class="title mb-0 text-nowrap"><?=(!empty($headData->pageTitle)) ? $headData->pageTitle : 'COMET POLYPLAST PVT LTD'?></h5>
				</div>
				<div class="mid-content"></div>
				<div class="right-content">
    					
    				<a href="<?=base_url("app/attendance")?>" style="vertical-align: text-top;"><i class="fas fa-user-check font-18"></i></a>
