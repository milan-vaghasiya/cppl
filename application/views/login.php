...
<head>
    ...
    <link href="<?=base_url()?>assets/css/login.css?v<?=time()?>" rel="stylesheet">
</head>
                ...
                <div class="row g-0">
                    <div class="col-xxl-9 col-lg-8 col-md-7 auth-bg">
                        <div class=" pt-md-5 p-4 d-flex">
                            ...
                            <!-- end bubble effect -->
                            <h4 class="col-xxl-12 p-0 p-sm-4 px-xl-0 text-white text-center">NATIVEBIT TECHNOLOGIES LLP</h4>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-lg-4 col-md-5">
										...
										<form class="custom-form mt-4 pt-2" id="loginform" action="<?=base_url('login/auth');?>" method="post">
											<div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <button class="btn btn-light ms-0" type="button"><i class="fa fa-user"></i></button>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <button class="btn btn-light ms-0" type="button" id="password-addon"><i class="fa fa-key"></i></button>
                        ...
                        <div class="login-poweredby font-medium pad-5">NATIVEBIT TECHNOLOGIES LLP</div>
                    </div>
                    <!-- end col -->
                </div>
            </div>
