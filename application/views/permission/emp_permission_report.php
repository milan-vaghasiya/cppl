                            ...
                            <div class="table-responsive">
                                    ...
                                    ?>
										<div class="accordion-item">
											<div class="accordion-heading m-0">
...
<div class="bottomBtn bottom-25 right-25 permission-write">
    <button type="button" class="btn btn-primary btn-round btn-outline-dashed font-bold permission-write save-form" style="letter-spacing:1px;" onclick="customStore({'formId':'empPermission','fnsave':'savePermission'});">SAVE PERMISSION</button>
</div>
