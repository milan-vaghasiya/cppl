...
/*if ('serviceWorker' in navigator) {
	...
	.register('https://cppl.nativebittechnologies.com/assets/app/app.js')
	.then(() => { console.log('Service Worker Registered'); });
}*/
if ('serviceWorker' in navigator) {
	navigator.serviceWorker
	.register('https://cppl.nativebittechnologies.com/assets/app/service-worker.js')
	.then(() => { console.log('Service Worker Registered'); });
}
...
function isThisDeviceRunningiOS(){
  if (['iPad Simulator', 'iPhone Simulator','iPod Simulator', 'iPad','iPhone','iPod'].includes(navigator.platform)){
	installText.innerHTML = 'Install mobile App template to your home screen for easy access click to safari share option "Add to Home Screen".';
	pwaBtn.remove();
	return true;
  }
}
